...
void setup()
{
  myservo1.attach(5);      // Sağ tarafdaki servo.İleri-Geri gitmeyi sağlayan servo
  myservo2.attach(6);      // Sol tarafdaki servo.Yukarı-Aşağı hareketi sağlar
...
void loop()
{
  ...
  { //
    ...
    { //
      ...
      servo1 = map(servo1, 1000, 1180, 0, 180);       //  map fonksiyonu ile 80-170 arasına sığdırılır
    ...
    { //
      ...
      servo2 = map(servo2, 2000, 2180, 0, 180);         // map fonksiyonu ile 30-120 arasına sığdırılır
    ...
    { //
      ...
      servo3 = map(servo3, 3000, 3180, 90, 120);       // map fonksiyonu ile 80-140 arasına sığdırılır
    ...
    { //
      ...
      servo4 = map(servo4, 4000, 4180, 90, 0);       // map fonksiyonu ile 80-140 arasına sığdırılır
      myservo4.write(servo4);                          // ve servo3 isimli servoya o değer verilir.
      delay(10);                                       //
    }
    ///////////////////////////////////////////////////////////////////////////////////////////////////////
    ////////////// YÖN KONTROLLERİ ////////////////////////////////////////////////////////////////////////
    ...
    { //
      digitalWrite(IN1, LOW);                         //
      digitalWrite(IN2, HIGH);                          // Gelen veri 4004 ise Robot SOLA döner
      digitalWrite(IN4, HIGH);                          //
      digitalWrite(IN3, LOW);                         //
    }                                                  /////////////////////////////////////////////////
    if (data == 4500)                                  /////////////////////////////////////////////////
    { //
      digitalWrite(IN1, HIGH);                          //
      digitalWrite(IN2, LOW);                         // Gelen veri 4006 ise Robot SAĞA döner
      digitalWrite(IN4, LOW);                         //
      digitalWrite(IN3, HIGH);                          //
    }                                                  //////////////////////////////////////////////////
    if (data == 4600)                                  //////////////////////////////////////////////////
